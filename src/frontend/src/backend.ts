...
export class Backend implements backendInterface {
    ...
    async submitBooking(arg0: string, arg1: string, arg2: string | null, arg3: string, arg4: string, arg5: string | null, arg6: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitBooking(arg0, arg1, to_candid_opt_n5(this._uploadFile, this._downloadFile, arg2), arg3, arg4, to_candid_opt_n5(this._uploadFile, this._downloadFile, arg5), arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        message: record_opt_to_undefined(from_candid_opt_n3(_uploadFile, _downloadFile, value.message)),
